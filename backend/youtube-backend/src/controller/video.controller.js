...
const getVideoByOwner = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, videos, "videos by owner fetched successfully"));
});
...
const togglePublishStatus = asyncHandler(async (req, res) => {
  ...
  if (!video) throw new ApiError(403, "Unauthorized or video not found");
...
const RemoveFromWatchHistory = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "removed from watch history successfully"));
});
